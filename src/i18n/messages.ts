...
export const messages = {
  es: {
    ...
    projects: {
      ...
      adminStatus: "Estado",
      adminReasonEs: "Motivo (ES)",
      adminReasonEn: "Motivo (EN)",
      adminLiveUrl: "URL en vivo (opcional)",
      adminSave: "Guardar",
  ...
  en: {
    ...
    projects: {
      ...
      adminStatus: "Status",
      adminReasonEs: "Reason (ES)",
      adminReasonEn: "Reason (EN)",
      adminLiveUrl: "Live URL (optional)",
      adminSave: "Save",
      adminSaving: "Saving…",
      adminSaved: "Saved",
